...
@section('content')
    <link rel="stylesheet" href="{{ asset('blog/css/reset_password.css') }}">
    <div class="container">
        <div class="row">
            <div class="mt-5 col-lg-10 col-xl-9 mx-auto">
                <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
                    <div style="background-image: url('{{ asset('Blog/image/register.jfif') }}')" class="card-img-left d-none d-md-flex">
                    </div>
