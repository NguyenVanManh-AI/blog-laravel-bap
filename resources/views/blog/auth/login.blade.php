...
@section('content')
    <link rel="stylesheet" href="{{ asset('blog/css/login.css') }}">
    <div class="container-fluid ps-md-0">
        <div class="row g-0">
            <div class="d-none d-md-flex col-md-4 col-lg-6 bg-image" style="background-image: url('{{ asset('blog/image/login.jfif') }}')"></div>
                                ...
                                <form method="POST" action="{{ route('login.user') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="d-grid">
                                        ...
                                        <div class="text-center">
                                            <a class="small" href="{{ route('register') }}">Do not have an account ? Sign
                                                up here.</a>
                                        </div>
                                        <div class="text-center">
                                            <a class="small" data-toggle="modal" data-target="#modalForGotPassword"
                                    ...
                                    <div class="social google">
                                        <a href="{{ route('google') }}">
                                            <img src="{{ asset('Blog/image/google.png') }}" alt=""> Sign up with
                                            Google
                                        </a>
                                    </div>
                                    <div class="social github">
                                        <a href="{{ route('github') }}">
                                            <img src="{{ asset('Blog/image/github.png') }}" alt=""> Sign up with
                                            Github
                                        </a>
                                    </div>
                                </form>
